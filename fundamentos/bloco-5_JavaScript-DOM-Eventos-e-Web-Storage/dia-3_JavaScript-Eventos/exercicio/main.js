...
function altereTech (evento) {
  let elementTech = document.querySelector('.tech');
  elementTech.classList.remove('tech');
  evento.target.classList.add('tech');
  input.value = '';
}
firstLi.addEventListener('click', altereTech);
secondLi.addEventListener('click', altereTech);
thirdLi.addEventListener('click', altereTech);
